...
const PAGES: Page[] = [
  ...
  },
  {
    ...
    body:
      'В настройках пять готовых оформлений — от тёплой бумаги до монохрома, — а у переписки свои обои. ' +
      'Всё меняется целиком и сразу, ничего подбирать по частям не нужно.',
    art: (
      <Art>
