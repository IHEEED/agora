  ...
  return (
    ...
    >
      <defs>
        ...
        {/* Холодная гамма: бирюза — синь — индиго.
            До этого здесь стоял тёплый градиент от малины к янтарю — то есть
            ровно инстаграмный, и кольцо читалось цитатой из чужого приложения.
            Холодный ряд не встречается больше нигде в интерфейсе: акценты у
            всех шести оформлений либо тёплые, либо нейтральные, поэтому кольцо
            ни с чем не путается и остаётся узнаваемым знаком «здесь новое». */}
        <linearGradient id={gradientId} x1="0.1" y1="1" x2="0.9" y2="0">
          <stop offset="0%" stopColor="#2fd8c5" />
          <stop offset="38%" stopColor="#2a9df4" />
          <stop offset="72%" stopColor="#4a5cf0" />
