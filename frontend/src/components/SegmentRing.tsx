  ...
  return (
    ...
    >
      <defs>
        ...
        {/* Голубая гамма и только она.
            Через бирюзу и индиго кольцо уезжало то в зелень, то в фиолет, и на
            маленьком кружке читалось не цветом, а переливом — ярким пятном без
            собственного имени. Три остановки одного голубого дают цвет, который
            узнаётся с первого взгляда и не спорит ни с одним из шести
            оформлений: голубого в акцентах нет нигде.
