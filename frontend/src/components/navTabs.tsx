...
/**
 * Порядок в боковой панели — свой, с профилем первым.
 *
 * В баре профиль стоит на правом краю, куда удобнее всего дотянуться большим
 * пальцем. Панель слева читается сверху вниз, как список, и первым в списке
 * должно стоять самое частое — своё. Один и тот же порядок в двух разных по
 * устройству навигациях был бы верностью коду, а не человеку.
 */
export const SIDEBAR_TABS = [TABS[3], TABS[0], TABS[1], TABS[2]] as const;
