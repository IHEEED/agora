    ...
    <>
      <div
        ...
        style={{
          ...
          // Размытие под шторкой, а не только затемнение. Затемнение говорит
          // «сюда нельзя», размытие — ещё и «на это не надо смотреть»: список
          // под шторкой перестаёт читаться, и глаз сам уходит на то, что
