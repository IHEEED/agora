...
export function HeaderAction() {
  ...
  const closes = pathname === '/settings' || pathname === '/create';
  ...
  return (
    <button
      ...
      style={{
        ...
        color: 'var(--accent)',
        // На самом поиске кнопка уезжает вправо синхронно с нижним баром.
        transform: isSearch ? 'translateX(140%)' : 'none',
        opacity: isSearch ? 0 : 1,
        pointerEvents: isSearch ? 'none' : 'auto',
        transition: 'transform 0.19s cubic-bezier(0.22, 1.2, 0.36, 1), opacity 0.13s ease',
      }}
    >
