...
export function FollowButton({
  ...
  // Значок в углу аватарки нужен только чтобы подписаться: плюс есть, пока не
  // подписан, и исчезает, как только подписался. Отписываются не с чужого лица
  // в ленте, а со страницы человека, где стоит полная кнопка. Минуса на
  // аватарке больше нет — он предлагал отписаться там, где это случайный жест.
  if (corner && following) return null;
