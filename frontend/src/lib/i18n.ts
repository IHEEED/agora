...
const DICTIONARY = {
  ru: {
    ...
    'communities.createFirst': 'Создать первый клуб',
    ...
    'profile.writeFirst': 'Написать запись',
    ...
    'comments.confirmDelete': 'Точно удалить?',
    'comments.editFailed': 'Не удалось сохранить правку',
  ...
  en: {
    ...
    'communities.createFirst': 'Create the first community',
    ...
    'profile.writeFirst': 'Write a post',
    ...
    'comments.confirmDelete': 'Delete for sure?',
    'comments.editFailed': 'Could not save the edit',
    'comments.deleteFailed': 'Could not delete',
  ...
  es: {
    ...
    'communities.createFirst': 'Crear el primer club',
    ...
    'profile.writeFirst': 'Escribir una publicación',
    ...
    'comments.confirmDelete': '¿Eliminar seguro?',
    'comments.editFailed': 'No se pudo guardar el cambio',
    'comments.deleteFailed': 'No se pudo eliminar',
