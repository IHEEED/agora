...
const DICTIONARY = {
  ru: {
    ...
    'profile.dragHint': 'Потяните, чтобы подвинуть. Колесо — масштаб',
  ...
  en: {
    ...
    'profile.dragHint': 'Drag to move. Wheel to zoom',
  ...
  es: {
    ...
    'profile.dragHint': 'Arrastra para mover. Rueda para zoom',
