...
const DICTIONARY = {
  ru: {
    ...
    'settings.plainBg': 'Чистый фон',
    'settings.plainBgHint': 'Убирает цветные пятна под интерфейсом',
  ...
  en: {
    ...
    'settings.plainBg': 'Plain background',
    'settings.plainBgHint': 'Removes the coloured glow behind the interface',
  ...
  es: {
    ...
    'settings.plainBg': 'Fondo liso',
    'settings.plainBgHint': 'Quita las manchas de color detrás de la interfaz',
